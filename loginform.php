...
if (isset($_POST['Butsave']))
{
  ...
  $sql = "SELECT * FROM doc where username = '$u_name' and password = '$pass' " ;
  ...
  {
    //there is no data
    header('Location: wrongmessage.php');
    die();
  }
        ...
        <form action="<?php echo $currentpage;?>" method="post" >
          <div class="form-row">
            <div class="col-md-4 form-group">
              <input type="text" name="uname" class="form-control" id="name" placeholder="Your user name" data-rule="minlen:4" data-msg="Please enter at least 4 chars">
              <div class="validate"></div>
            </div>

            <div class="col-md-4 form-group">
              <input type="text" class="form-control" name="pass" id="address" placeholder="Your Password" data-rule="minlen:4">
              <div class="validate"></div>
            </div>
          </div>
